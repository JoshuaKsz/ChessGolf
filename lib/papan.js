...
export class Papan {
    constructor(Canvas) {
        ...
        this.grid.forEach((bidak, index) => {
            if (bidak) { // Check if the piece is not null
                if (bidak.tipe == 'p') {
        ...
        arrBidak.forEach((bidak, index) => {
            switch (bidak.element.toUpperCase()) {
                case 'P':
                    ...
                    if (bidak.lokasiIndex % 8 == 0 && pionGerak+bidak.lokasiIndex-1 >= 0 && pionGerak+bidak.lokasiIndex-1 < 64) {
                        bidak.bisaGerakKe.push(pionGerak+bidak.lokasiIndex-1);
                    }
                    if (bidak.lokasiIndex+1 % 8 == 0 && pionGerak+bidak.lokasiIndex+1>= 0 && pionGerak+bidak.lokasiIndex+1 < 64) {
                        bidak.bisaGerakKe.push(pionGerak+bidak.lokasiIndex+1);
                    }
                    break;
                case 'N':
            ...
            if (this.grid[indexAwal].bisaGerakKe.includes(indexTujuan)) {
                if (this.grid[indexTujuan] != null){
                    if (this.grid[indexTujuan].tipe == 'p') {
                        this.bidakPutih.slice(this.bidakPutih.findIndex(bidak => bidak.lokasiIndex == indexTujuan), 1);
                    } else if (this.grid[indexTujuan].tipe == 'h') {
                        this.bidakHitam.slice(this.bidakHitam.findIndex(bidak => bidak.lokasiIndex == indexTujuan), 1);
                    }
                }
