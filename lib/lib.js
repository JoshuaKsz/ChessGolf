export class DrawLib {
    constructor (canvasid) {
        ...
        // Dapat warning jadi ditambahkan https://stackoverflow.com/questions/74020182/canvas2d-multiple-readback-operations-using-getimagedata-are-faster-with-the-wi
        ...
        // animasi @ index.js:108
        // main @ index.js:133
        // (anonymous) @ index.js:141

        this.c_handler = document.querySelector(`#${canvasid}`);
        this.ctx = this.c_handler.getContext("2d", { willReadFrequently: true });
    ...
    titik(x,y, color) {
        ...
        if (x < this.c_handler.width && x >= 0 && y < this.c_handler.height && y >= 0) {
            let index = (Math.floor(x) + (Math.ceil(y) * this.c_handler.height))*4;
